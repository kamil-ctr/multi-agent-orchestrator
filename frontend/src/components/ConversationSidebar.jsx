...
import { ChevronLeft, ChevronRight, Search, MessageSquarePlus, Pencil, Trash2 } from "lucide-react";
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-2 pb-3">
        ...
        {!loading && filtered.length === 0 && (
          <div className="px-2 py-4 text-xs" style={{ color: "var(--text-muted)" }}>No conversations yet.</div>
        )}

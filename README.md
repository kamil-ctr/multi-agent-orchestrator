...
[![Tests](https://img.shields.io/badge/tests-44%2F44%20passing-brightgreen)](backend/tests)
...
|---|---|---|---|---|
| `POST` | `/api/query` | Legacy shortcut: starts a pipeline run as a background task, creating a single-message conversation under the hood | `{prompt: str, image_base64?: str, image_mime?: str, file_context?: str, file_name?: str, use_cache?: bool, enabled_agents?: string[]}` | `{query_id: str, conversation_id: int}` |
